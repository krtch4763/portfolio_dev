...
const Contact = () => {
  return (
    <div className="pt-16 pb-16">
      <div className="w-[90%] md:w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        {/* Text contact */}
        <div>
          ...
          <p className="text-gray-400 mt-6 text-base  sm:text-lg">
            Reach out to me todey and let is discuss how I can help you achieve
            your goals.
          </p>
          {/* info */}
          <div className="mt-7">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <p className="text-xl font-bold text-gray-400">+66454446564</p>
            </div>
            <div className="flex items-center space-x-3 mb-4">
        ...
        >
          ...
          <input
            ...
            className="px-4 py-3.5 bg-[#363669] mt-6 text-white outline-none rounded-md w-full placeholder:text-white/70"
          />
          <input
            type="text"
          ...
          <textarea
            ...
            className="px-4 py-3.5 bg-[#363669] mt-6 text-white outline-none rounded-md w-full placeholder:text-white/70 h-[10rem]"
          ></textarea>
